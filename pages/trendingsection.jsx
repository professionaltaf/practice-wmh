...
const TrendingSection = () => {
  ...
  return (
    <section className=" text-white py-16 relative container mx-auto">
            ...
            >
              ...
              <div className="p-6 text-center">
                ...
                <Link href={post.link} passHref>
                  <span className="bg-[#EE2229] text-white px-6 py-2 rounded-full font-medium hover:bg-[#EE2229] transition-all duration-300">
                    Read More
                  </span>
                </Link>
              </div>
